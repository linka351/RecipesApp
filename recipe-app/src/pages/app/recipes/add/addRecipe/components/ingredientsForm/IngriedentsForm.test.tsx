...
describe("IngredientsForm", () => {
	...
	test("displays validation errors", async () => {
		...
		expect(screen.getByText("Nazwa składniku powinna składać się conajmniej z trzech liter")).toBeInTheDocument();

		await userEvent.type(ingredientInput, "Test ingredient");
		await userEvent.click(submitButton);

		expect(screen.queryByText("Nazwa składniku powinna składać się conajmniej z trzech liter")).not.toBeInTheDocument();
	});
